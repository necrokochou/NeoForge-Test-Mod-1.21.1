package net.necrokochou.testmod.block;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<StairBlock> BISMUTH_STAIRS = registerBlock(
            "bismuth_stairs",
    ...
    public static final DeferredBlock<SlabBlock> BISMUTH_SLAB = registerBlock(
            "bismuth_slab",
    ...
    public static final DeferredBlock<FenceBlock> BISMUTH_FENCE = registerBlock(
            "bismuth_fence",
    ...
    public static final DeferredBlock<FenceGateBlock> BISMUTH_FENCE_GATE = registerBlock(
            "bismuth_fence_gate",
    ...
    public static final DeferredBlock<WallBlock> BISMUTH_WALL = registerBlock(
            "bismuth_wall",
    ...
    public static final DeferredBlock<DoorBlock> BISMUTH_DOOR = registerBlock(
            "bismuth_door",
    ...
    public static final DeferredBlock<TrapDoorBlock> BISMUTH_TRAPDOOR = registerBlock(
            "bismuth_trapdoor",
